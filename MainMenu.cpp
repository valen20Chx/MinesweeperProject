...
MainMenu::MainMenu(SDL_Renderer * pRenderer, int x, int y, int width, int height):Scene(pRenderer,x, y, width, height)
{
	...
	mBtnTxtMulti = new ButtonText({ 0, 0, 64, 16 }, { 0, 300, 32, 70 }, pRenderer, 10, 10, nullptr, "Ressources/Image/Default/Button_Default_Empty_Rest.png", "Ressources/Image/Default/Button_Default_Empty_Pressed.png", 16, { 100,100,255, 255 }, "Ressources/Font/Open_Sans/OpenSans-Bold.ttf", "Multi");
