...
MainMenu::MainMenu(SDL_Renderer * pRenderer, int x, int y, int width, int height):Scene(pRenderer,x, y, width, height)
{
    ...
    mBtnTxtMulti = new ButtonText({ 0, 0, 64, 16 }, { 200, 300, 32, 70 }, pRenderer, 10, 10, 16, { 100,100,255, 255 }, "Ressources/Font/Open_Sans/OpenSans-Bold.ttf", "Solo")
	this->mBtnTxtMulti->setPath("Ressources/Image/Default/Button_Default_Empty_Rest.png", "Ressources/Image/Default/Button_Default_Empty_Pressed.png");


	this->mBtnFermer = new Button({ 0, 0, 16, 16 }, { this->width -(this->width / 16) - 2, 2, this->width / 16, this->height / 16 }, true, this->mRenderer);
	this->mBtnFermer->setPath("Ressources/Image/Default/Button_Quit_Rest.png", "Ressources/Image/Default/Button_Quit_Pressed.png");
}
